...
public class SearchCompanyAdapter extends BaseAdapter implements Filterable {

    public Context context;
    public List<CompanyListResponseDataBean> IndividualListResponseDataBeanArrayList;
    public List<CompanyListResponseDataBean> orig;

    public SearchCompanyAdapter(Context context, List<CompanyListResponseDataBean> IndividualListResponseDataBeanArrayList) {
        super();
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                final List<CompanyListResponseDataBean> results = new ArrayList<CompanyListResponseDataBean>();
                if (orig == null)
                    orig = IndividualListResponseDataBeanArrayList;
                if (constraint != null) {
                    if (orig != null && orig.size() > 0) {
                        for (final CompanyListResponseDataBean g : orig) {
            ...
            protected void publishResults(CharSequence constraint,
                ...
                IndividualListResponseDataBeanArrayList = (ArrayList<CompanyListResponseDataBean>) results.values;
